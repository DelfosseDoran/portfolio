  ...
  <>
    ...
    <div className="sm:grid grid-cols-3 lg:grid-cols-5">
      <Image
        ...
        alt="red dragonfly"
        divClass="row-span-3"
        color="bg-countries-oman"
      />
      <div className="hidden lg:col-span-1 lg:bg-countries-oman lg:flex lg:col-start-2"></div>
      <Image
      ...
      <Image
        ...
        color="bg-countries-oman"
      />
      <div className="bg-countries-oman col-span-2 lg:hidden"></div>
    </div>
    <div className="absolute bg-countries-oman w-full h-12"></div>
  </>
);}
