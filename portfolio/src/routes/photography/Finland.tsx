    ...
    <>
      ...
      <div className="sm:grid grid-cols-3 lg:grid-cols-5">
        ...
        <Image
          ...
          color="bg-countries-finland"
        />
        <div className="hidden lg:flex lg:row-span-3 bg-countries-finland"></div>
        <Image
        ...
        <Image
          ...
          color="bg-countries-finland"
        />
        <div className=" bg-countries-finland h-20 lg:hidden"></div>
      </div>
      <div className="absolute bg-countries-finland w-full h-12"></div>
    </>
  );
};
