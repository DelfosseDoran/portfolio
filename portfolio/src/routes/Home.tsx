        ...
        <div className="lg:flex justify-center overflow-hidden lg:pb-8">
          <div className="lg:w-2/4 ">
            <div className=" lg:mr-10 md:mb-12">
              <h1 className="text-2xl leading-tight p-4  sm:text-[3rem] font-bold text-raisin-black-700 dark:text-[#80ced7] text-center lg:text-left">
                ...
                <div>
                  ...
                  <div className="pl-2">
                    ...
                    <div className="pl-2 font-Signika text-lg">
                      ...
                      <p>2022 - now Multimedia en Creative Technology (Next Web Developer)</p>
                    </div>
                  </div>
                </div>
                <div>
          ...
          <div className="-pt-2 h-fit lg:w-1/4 ">
            <div className="lg:mt-2 bg-Feldgrau dark:bg-brunswick-green  p-4 text-lemon-chiffon lg:rounded-lg lg:shadow-lg">
              <div>
          ...
          <div className="flex gap-2 justify-between p-4 ">
            ...
            <div className="sm:flex justify-end gap-4 items-center sm:flex-row grid grid-cols-2">
              <a
                ...
                className="p-2 lg:bg-raisin-black-200 w-fit h-fit lg:focus:bg-raisin-black-400 lg:hover:bg-raisin-black-400 rounded-lg dark:lg:bg-platinum dark:lg:hover:bg-non-photo-blue dark:lg:focus:bg-non-photo-blue"
              >
                <Mail className=" stroke-raisin-black-600 lg:stroke-raisin-black-500 focus:stroke-raisin-black-700 hover:stroke-raisin-black-700 w-8 h-8 sm:w-12 sm:h-12 dark:stroke-platinum dark:lg:stroke-Feldgrau dark:focus:stroke-non-photo-blue dark:hover:stroke-non-photo-blue dark:lg:focus:stroke-brunswick-green dark:lg:hover:stroke-brunswick-green" />
              </a>
              <a
                href="https://www.instagram.com/dorandelfosse/"
                className="p-2 lg:bg-raisin-black-200 w-fit h-fit lg:focus:bg-raisin-black-400 lg:hover:bg-raisin-black-400 rounded-lg dark:lg:bg-platinum dark:lg:hover:bg-non-photo-blue dark:lg:focus:bg-non-photo-blue"
              >
                <Instagram className=" stroke-raisin-black-600 lg:stroke-raisin-black-500 focus:stroke-raisin-black-700 hover:stroke-raisin-black-700 w-8 h-8 sm:w-12 sm:h-12 dark:stroke-platinum dark:lg:stroke-Feldgrau dark:focus:stroke-non-photo-blue dark:hover:stroke-non-photo-blue dark:lg:focus:stroke-brunswick-green dark:lg:hover:stroke-brunswick-green" />
              </a>
              <a
                href="https://github.com/DelfosseDoran"
                className="p-2 lg:bg-raisin-black-200 w-fit h-fit lg:focus:bg-raisin-black-400 lg:hover:bg-raisin-black-400 rounded-lg dark:lg:bg-platinum dark:lg:hover:bg-non-photo-blue dark:lg:focus:bg-non-photo-blue"
              >
                <Github className="stroke-raisin-black-600 lg:stroke-raisin-black-500 focus:stroke-raisin-black-700 hover:stroke-raisin-black-700 w-8 h-8 sm:w-12 sm:h-12 dark:stroke-platinum dark:lg:stroke-Feldgrau dark:focus:stroke-non-photo-blue dark:hover:stroke-non-photo-blue dark:lg:focus:stroke-brunswick-green dark:lg:hover:stroke-brunswick-green" />
              </a>
              <a
                href="https://be.linkedin.com/in/doran-delfosse-684290283"
                className="p-2 lg:bg-raisin-black-200 w-fit h-fit lg:focus:bg-raisin-black-400 lg:hover:bg-raisin-black-400 rounded-lg dark:lg:bg-platinum dark:lg:hover:bg-non-photo-blue dark:lg:focus:bg-non-photo-blue"
              >
                <Linkedin className="stroke-raisin-black-600 lg:stroke-raisin-black-500 focus:stroke-raisin-black-700 hover:stroke-raisin-black-700 w-8 h-8 sm:w-12 sm:h-12 dark:stroke-platinum dark:lg:stroke-Feldgrau dark:focus:stroke-non-photo-blue dark:hover:stroke-non-photo-blue dark:lg:focus:stroke-brunswick-green dark:lg:hover:stroke-brunswick-green" />
              </a>
            </div>
          </div>
