    ...
    <>
      ...
      <div className="sm:grid grid-cols-3 lg:grid-cols-5">
        <Image
          ...
          color="bg-countries-finland dark:bg-countries-dark-finland"
        />
        <Image
        ...
        <Image
          ...
          color="bg-countries-finland dark:bg-countries-dark-finland"
        />
        <div className="hidden lg:flex lg:row-span-3 bg-countries-finland dark:bg-countries-dark-finland"></div>
        <Image
        ...
        <Image
          ...
          color="bg-countries-finland dark:bg-countries-dark-finland"
        />
        <div className=" bg-countries-finland dark:bg-countries-dark-finland h-20 lg:hidden"></div>
      </div>
      <div className="absolute bg-countries-finland dark:bg-countries-dark-finland w-full h-12"></div>
    </>
  );
};
